...
export const PROJECTS: Project[] = [
  {
    ...
    links: [
      { label: "PAPER", href: "https://ieeexplore.ieee.org/document/11619021" },
      { label: "CODE (EDGEAGENT)", href: "https://github.com/ddps-lab/edgeagent" },
      { label: "CODE (WASMMCP)", href: "https://github.com/ddps-lab/wasmmcp" },
    ],
  ...
  },
  {
    ...
    links: [
      ...
      { label: "CODE", href: "https://github.com/ddps-lab/callisto" },
    ],
